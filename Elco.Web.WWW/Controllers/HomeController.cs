...
namespace Elco.Web.WWW.Controllers
{
    public class HomeController : BaseController
    {
        ...
        {
            //新闻中心
            var newsCenter = ArticleService.ListWithoutPage(Elco.Config.GeneralConfig.NewsRootId, 6, true);
            ViewBag.NewsCenter = newsCenter;

            //焦点图片
            var focus = ArticleService.ListWithoutPage(200,4);
            //焦点图有两张图（大图和小图）
            ...
            //电子月刊
            var issue = ArticleService.ListWithoutPage(134,6,true);
            ViewBag.Issue = issue;

            //活动与建议 177
            var announcement = ArticleService.ListWithoutPage(177,1);
        ...
        public ActionResult RenderNav(CategoryInfo currentCategoryInfo, string linkFormat, CategoryInfo rootCategoryInfo, bool isShowTitle = false)
        {
            ...
            sb.Append("<p class=\"floatR\"><strong>当前位置： </strong><a href=\"/\">首页</a>");

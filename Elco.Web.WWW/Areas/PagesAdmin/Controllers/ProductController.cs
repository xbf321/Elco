...
namespace Elco.Web.WWW.Areas.PagesAdmin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult List() {
            ...
            var oldCatList = CategoryService.ListAllSubCatById(GeneralConfig.ProductRootId);
        ...
        public ActionResult Prop()
        {
            ...
            //获取产品中心一级分类
            var parentCatList = CategoryService.ListByParentId(Elco.Config.GeneralConfig.ProductRootId);
        ...
        public ActionResult RenderCatJSON() {
            ...
            var list = CategoryService.ListAllSubCatById(Elco.Config.GeneralConfig.ProductRootId).Where(p => { return p.IsDeleted == false && p.ParentId != 0; });
